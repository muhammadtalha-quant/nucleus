{
  description = "A fully functional starter for NixOS based on Nucleus Architecture that includes a fully integrated experience with the K Desktop Environment.";
